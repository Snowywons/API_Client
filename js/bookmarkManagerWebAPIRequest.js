...
const apiBaseURL= "https://ripe-phrygian-stoat.glitch.me/api/bookmarks";
...
function webAPI_getBookmarkParams(params, successCallBack, errorCallBack) {
    console.log("Params : " + params);
    $.ajax({
        url: apiBaseURL + "?" + params,
        type: 'GET',
        contentType:'text/plain',
        data:{},
        success: bookmark => { successCallBack(bookmark); 
            console.log("webAPI_getBookmarkParams - success");},
        error: function(jqXHR, textStatus, errorThrown) {
            errorCallBack(errorThrown);
            console.log("webAPI_getBookmarkParams - error");
        }
    });
}
...
function webAPI_addBookmark(bookmark, successCallBack, errorCallBack) {
    ...
    $.ajax({
        ...
        success: () => {successCallBack();  
            console.log("webAPI_addBookmark - success");},
        error: function(jqXHR, textStatus, errorThrown) {
            errorCallBack(errorThrown);
...
function webAPI_modifyBookmark(bookmark, successCallBack, errorCallBack) {
    ...
    $.ajax({
        ...
        data: JSON.stringify(bookmark),
        success:() => {successCallBack();  
            console.log("webAPI_modifyBookmark - success");},
        error: function(jqXHR, textStatus, errorThrown) {
            errorCallBack(errorThrown);
